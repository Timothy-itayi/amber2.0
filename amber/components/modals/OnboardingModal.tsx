...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    content: [
      'You have been assigned to Sector 9',
      'Transit Point A.',
      '',
      'Your role is to verify the identity',
      'of all passengers passing through',
      'this checkpoint.',
    ],
  ...
  },
  {
    ...
    title: 'YOUR DUTIES',
    content: [
      'Use scanning equipment to check',
      'identification documents.',
      '',
      'Cross-reference faces with the',
      'Central Watcher database.',
      '',
      'Report discrepancies immediately.',
    ],
    footer: 'COMPLIANCE IS MANDATORY',
  },
  {
    ...
    content: [
      ...
      'you must prioritize locating',
      'the subject.',
      '',
      'All other duties become secondary.',
      '',
      'Failure to comply will result in',
      'disciplinary action.',
    ],
    footer: 'WARNING: ALL DATA IS MONITORED',
  },
  {
    header: 'FINAL NOTICE',
    title: 'REMEMBER',
    content: [
      ...
      'All transmissions are recorded.',
      '',
      'Trust the system.',
      'The system protects us all.',
      '',
      'GOOD LUCK, OPERATOR.',
    ],
